...
<div class = "container-fluid">
  <div class = "card-header py-3">
    <h6 class = "m-0 font-weight-bold text-primary"> Email Active Subscribers
...
FROM subscription
INNER JOIN organisation ON subscription.organisationid=organisation.id AND subscription.status='active' AND subscription.payment_status='paid'";
