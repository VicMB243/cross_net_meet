...
<div class = "container-fluid">
  <div class = "card-header py-3">
    <h6 class = "m-0 font-weight-bold text-primary"> Email Organisations with pending subscriptions
...
<div class = "card-body">
  <div class = "table responsive">
    ...
    include 'controller/config.php';
        ...
        $query = "SELECT subscription.id, organisation.name, organisation.email, subscription.phone,subscription.status,subscription.payment_status
FROM subscription
INNER JOIN organisation ON subscription.organisationid=organisation.id AND subscription.status='pending' AND subscription.payment_status='not_paid'";
