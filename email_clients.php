    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="clients_btn" class="btn btn-primary">Save</button>
        </div>
...
<div class ="container-fluid">
  ...
  <div class= "card-heaader py-3">
    <h6 class "m-0 font-weight-bold text-primary"> Email Clients
...
<div class = "card-body">
  <div class = "table responsive">
    ...
    <form method="POST" action="model/email_clients.php">
    <div class="table-responsive">
...
<input class="checkbox"  type="checkbox" name="acs[]" checked="" value="<?php echo $row['email'] ?>"></td>
            ...
            <td><?php  echo "client" .$row['id']; ?></td>
            <td><?php  echo $row['name']; ?></td>
            
            <td><?php  echo $row['email']; ?></td>
            <td><?php  echo $row['company']; ?></td>
            <td><?php  echo $row['projectlead']; ?></td>
