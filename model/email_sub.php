...
header("location:../email_sub.php?oops");
exit();
}
...
FROM subscription
INNER JOIN organisation ON subscription.organisationid=organisation.id  WHERE organisation.email = '$email'";
...
header("location:../email_sub.php?suc");
?>