...
header("location:../websitecontact.php?oops");
exit();
}
foreach ($_POST['message'] as $key) {
$mail = new PHPMailer;
...
$mail->setFrom( 'sales@esokoni-markets.com');
  $email = $key;
  $sql = "select * from website_contact where email = '$email'";
...
header("location:../websitecontact.php?suc");
?>